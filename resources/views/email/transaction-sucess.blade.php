                                ...
                                <table border="0" cellpadding="0" cellspacing="0" role="presentation"
                                    ...
                                    <tr>
                                        <td align="center"
                                            ...
                                            <div
                                                style="font-family:Playfair Display, Times New Roman, serif;font-size:30px;font-weight:bold;line-height:1;text-align:center;color:#262E44;">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td style="width:550px;">
                                                            <img alt="" height="auto" src="images/Mask Group 20@2x.jpg"
                                                                style="border:none;display:block;outline:none;text-decoration:none;height:auto;width:100%;font-size:13px;"
                                                                width="550" />
                                                        </td>
                                                    </tr>
                            ...
                            <div class="mj-column-per-100 mj-outlook-group-fix"
                                ...
                                <table border="0" cellpadding="0" cellspacing="0" role="presentation" width="100%">
                                    <tbody>
                                        <tr>
                                            <td
                                                style="border-bottom:2px dashed #eee;vertical-align:middle;padding-bottom:30px;">
                                                <table border="0" cellpadding="0" cellspacing="0" role="presentation"
                                                    style="" width="100%">
                                                    <tr>
                                                        <td align="left"
                                                            ...
                                                            <div
                                                                style="font-family:Assistant, Helvetica, sans-serif;font-size:18px;line-height:28px;text-align:left;color:#262E44;">
                                                                Hi, Angel <br><br> Tiket digital kamu sudah berhasil
                                                                dicetak.<br> Booking <strong>ID #22081996 </strong>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td align="left"
                                                            ...
                                                            <table cellpadding="0" cellspacing="0" width="100%"
                                                                border="0"
                                                                style="color:#262E44;font-family:Assistant, Helvetica, sans-serif;font-size:18px;line-height:28px;table-layout:auto;width:100%;border:none;">
                                                                <tr>
                                                                ...
                                                                <tr>
                                                                    <td><strong>Suzan</strong></td>
                                                                    <td style="text-align: right">Japan, JPN</td>
                                                            </table>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                    ...
                                                    <tr>
                                                        <td align="center" vertical-align="middle"
                                                            ...
                                                            <table border="0" cellpadding="0" cellspacing="0"
                                                                ...
                                                                <tr>
                                                                    <td align="center" bgcolor="#EE9C1F"
                                                                        role="presentation"
                                                                        style="border:none;border-radius:10px;cursor:auto;mso-padding-alt:10px 25px;background:#EE9C1F;"
                                                                        valign="middle">
                                                                        <p
                                                                            style="display:inline-block;background:#EE9C1F;color:#ffffff;font-family:Assistant, Helvetica, sans-serif;font-size:18px;font-weight:bold;line-height:120%;margin:0;text-decoration:none;text-transform:none;padding:10px 25px;mso-padding-alt:0px;border-radius:10px;">
                                                                            Check Detail </p>
                                                                    </td>
                                                                </tr>
                                                            </table>
                                ...
                                <table border="0" cellpadding="0" cellspacing="0" role="presentation"
                                    ...
                                    <tr>
                                        <td align="left"
                                            style="font-size:0px;padding:10px 25px;padding-right:25px;padding-left:25px;word-break:break-word;">
                                            <div
                                                style="font-family:Assistant, Helvetica, sans-serif;font-size:18px;line-height:20px;text-align:left;color:#262E44;">
                                                Butuh Bantuan ?</div>
                                        </td>
                                    </tr>
                                </table>
                                ...
                                <table border="0" cellpadding="0" cellspacing="0" role="presentation"
                                    ...
                                    <tr>
                                        <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                            ...
                                            padding-left: 10px; 
                                            color: #262E44;
                                            font-family: Assistant, Helvetica, sans-serif;"> support@nomads.id <br>
                                                        0857 - 7874 - 2589 </td>
                                                </tr>
                                            </table>
                                        </td>
                                ...
                                <table border="0" cellpadding="0" cellspacing="0" role="presentation"
                                    ...
                                    <tr>
                                        <td align="center"
                                            ...
                                            <div
                                                style="font-family:Assistant, Helvetica, Arial, sans-serif;font-size:18px;line-height:1;text-align:center;color:#B2B2B2;">
